...
public class SuggestCommand implements Command {
    ...
    public void run(JDA bot, GuildMessageReceivedEvent event, String[] args) {
        ...
        try {
            bot.getTextChannelById(String.valueOf(Config.configuration.get("suggest-id")));
        } catch (Exception e) {
        ...
        bot.getTextChannelById(String.valueOf(Config.configuration.get("suggest"))).sendMessage(embed.build()).queue();
