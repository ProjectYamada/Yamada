...
@Command(name="yandere",description = "Gets an image from Yande.re",group="anime",nsfw = true)
public class YandereCommand {
    public void run(JDA bot, GuildMessageReceivedEvent event, String[] args) {
        ...
        try {
            CloseableHttpResponse response = httpClient.execute(
                    new HttpGet(String.format("https://yande.re/post/index.json%s", params)));
